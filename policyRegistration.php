...
if(isset($_POST['done']))
{
 ...
 $tprice=$_POST['tprice'];
 $deduc=$_POST['ded'];
 $q="INSERT INTO `policy`(`policy_no`, `coverage`, `issue_date`, `term_price`, `deduciton`) VALUES ('$pid','$cover','$idate','$tprice','$deduc')";
 mysqli_query($con,$q);
...
<body>
    <div class="cusreg"><h1>Enter Policy Details</h1> </div><br>
    <div class="main">
        <form method="post">
        <label class="p_idl">Policy No.</label>
        <input class="p_id" type="number" name="p_id"><br><br>
